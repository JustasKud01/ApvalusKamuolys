...
<form action="../inc/pridetivarzybas.inc.php" method="post">
  ...
  <?php
    if(isset($_GET["error"])) {
      if($_GET["error"] == "emptyinput") {
        ...
        echo "<p style='color:green; text-align: center;'>Sėkmingai pridėjote varzybas į duomenų bazę!</p>";
      }
    }
  ?>
  <div class="container">
    ...
    <button class = "loginbutton" name="submit" type="submit">Pridėti naujas varžybas</button>
  </div>
