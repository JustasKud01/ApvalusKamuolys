...
<form action="../inc/sunaikintivartotoja.inc.php" method="post">
  ...
  <?php
    if(isset($_GET["error"])) {
      if($_GET["error"] == "emptyinput") {
        ...
        echo "<p style='color:green; text-align: center;'>Sėkmingai išregistravote vartotoją!</p>";
      }
  ...
  ?>
  <div class="container">
    <label for="uname"><b>Vartotojo vardas kurį norite ištrinti</b></label>
    <input type="text" placeholder="Įveskite savo pilną vardą" name="username" id ="username">
    <button class = "loginbutton" name="submit" type="submit">Sunaikinti</button>
  </div>
